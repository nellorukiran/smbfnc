...
function Calendar({ className, classNames, showOutsideDays = true, ...props }: CalendarProps) {
  return (
    <DayPicker
      ...
      className={cn("rdp p-3 bg-card border border-border rounded-lg shadow-sm", className)}
      classNames={{
        ...
        day_selected:
          "bg-primary text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground font-semibold border border-primary/20 shadow-sm rdp-selected",
        day_today: "bg-accent text-accent-foreground font-semibold border border-border/50 rdp-today",
        day_outside:
          "day-outside text-muted-foreground opacity-50 aria-selected:bg-accent/50 aria-selected:text-muted-foreground aria-selected:opacity-30 font-['Inter'] rdp-outside",
        day_disabled: "text-muted-foreground opacity-50 cursor-not-allowed font-['Inter'] rdp-disabled",
